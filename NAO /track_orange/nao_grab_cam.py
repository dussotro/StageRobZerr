...
seuil_max = 200    # area > seuil => unwalk
seuil_mid = 150    # area > seuil => stay
seuil_min = 4    # area > seuil => walk
# seuils , suivi plus loin et plus stable
seuil_max = 100 # area > seuil => unwalk
seuil_mid = 50 # area > seuil => stay
seuil_min = 4    # area > seuil => walk
